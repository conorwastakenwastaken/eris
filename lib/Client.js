...
class Client extends EventEmitter {
    ...
    * @returns {Promise}
    */
    banGuildMember(guildID, userID, deleteMessageSeconds, reason) {
        if(!isNaN(deleteMessageSeconds) && (deleteMessageSeconds < 0 || deleteMessageSeconds > 604800)) {
            return Promise.reject(new Error(`Invalid deleteMessageSeconds value (${deleteMessageSeconds}), should be a number between 0-604800 inclusive`));
        }
