  ...
  wsEvent(packet) {
    switch (packet.t) {
      ...
      case "MESSAGE_UPDATE": {
         ...
         * @prop {Object?} oldMessage.activity The activity specified in the message
      ...
      case "INVITE_CREATE": {
        ...
        if (packet.d.role_ids !== undefined) {
          inviteData.roles = packet.d.role_ids
         ...
         */
        this.emit("inviteCreate", guild, new Invite(inviteData, this.client));
        break;
      }
      case "INVITE_DELETE": {
        const guild = this.client.guilds.get(packet.d.guild_id);
