    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_AUDIT_LOG_ENTRY_CREATE": {
                ...
                /**
                 * Fired when a guild audit log entry is created. This event is only sent to bots with the VIEW_AUDIT_LOG permission.
                 * @event Client#guildAuditLogEntryCreate
                 * @prop {Guild} guild The guild
                 * @prop {GuildAuditLogEntry} entry The audit log entry
                 */
                this.emit("guildAuditLogEntryCreate", guild, new GuildAuditLogEntry(packet.d, guild));
                break;
            }
            ...
            case "GUILD_EMOJIS_UPDATE": {
                ...
                * @prop {Array<Emoji>} emojis The updated emojis of the guild
                * @prop {Array<Emoji>?} oldEmojis The old emojis of the guild. If the guild is uncached, this will be null
                */
