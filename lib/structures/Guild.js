...
* @prop {Array<Emoji>} emojis An array of guild emoji objects
...
class Guild extends Base {
    ...
    * @returns {Promise}
    */
    banMember(userID, deleteMessageSeconds, reason) {
        return this._client.banGuildMember.call(this._client, this.id, userID, deleteMessageSeconds, reason);
    }
