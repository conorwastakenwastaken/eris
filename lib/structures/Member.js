...
* @prop {String} displayName The server nickname of the member, their global name, or their username if they don't have either set
...
* @prop {String} highestRole The ID of the members' highest role
...
class Member extends Base {
    ...
    * @arg {Number} [deleteMessageSeconds=0] Number of seconds to delete messages for, between 0-604800 inclusive
    * @arg {String} [reason] The reason to be displayed in audit logs
    * @returns {Promise}
    */
    ban(deleteMessageSeconds, reason) {
        return this.guild.shard.client.banGuildMember.call(this.guild.shard.client, this.guild.id, this.id, deleteMessageSeconds, reason);
    }
